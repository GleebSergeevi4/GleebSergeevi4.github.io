...
# Автообновление (лайв-режим генерации)
python generator/main.py --watch --interval 60
...
- Сайт статический: «лайв» обновление работает через watch-режим генератора
...
- Расписание автоматических обновлений через cron
